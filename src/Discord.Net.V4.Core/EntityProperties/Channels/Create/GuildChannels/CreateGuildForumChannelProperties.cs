...
public class CreateGuildForumChannelProperties : CreateGuildChannelBaseProperties
{
    ...
    protected override Optional<ChannelType> ChannelType => Discord.ChannelType.Forum;
